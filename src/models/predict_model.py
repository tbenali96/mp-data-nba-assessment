...
def predict_player_career(
    data_for_prediction: pd.DataFrame, model_path: str, scaler_path: str
) -> np.array:
    logging.info("Building the features for the test dataset")
    data = build_features(
        raw_data=data_for_prediction, train_or_test="test", scaler_path=scaler_path
    )
...
if __name__ == '__main__':
    ...
    predictions = predict_player_career(
